...
#data_transforms_custom = transforms.Compose([Rescale(224),
#                                             Normalize(mean, std),
#                                             ToTensor()])

## Make a grid from batch
#fig = plt.figure()
#out = torchvision.utils.make_grid(samples['img1'])
#imshow(out, title=['actual'])
#
#fig = plt.figure()
#out = torchvision.utils.make_grid(samples['img2'])
#imshow(out, title=['predicted'])
